...
public class FormCliente extends javax.swing.JDialog {
    DAOCliente daoCliente = new DAOCliente(); // onde contem metodos de salvar buscar e remover da lista 
    
    public void atualizaTabela () {
        listCliente.clear(); // limpar tabela
        listCliente.addAll(daoCliente.getLista()); //pegar a lista e adicionar todos os elementos da lista pegando ds listcidade da classe Dados
        int linha = listCliente.size() -1;  // para ver se vai ter conteudo na lista
        if(linha >=0 ) { // verificando se tem conteudo na lista
            tblCliente.setRowSelectionInterval(linha, linha); //pegar o tamanho da lista e jogar
            tblCliente.scrollRectToVisible(tblCliente.getCellRect(linha, linha, true)); // criar barra de rolagem
        }
    ...
    private void trataEdicao (boolean editando) {
        ...
        txtEndereco.setEditable(editando);
        txtEndereco.setEditable(editando);
    ...
    private void initComponents() {
        ...
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblCliente, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.idCliente}"), txtCodigo, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, tblCliente, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.nomeCliente}"), txtNome, org.jdesktop.beansbinding.BeanProperty.create("text"));
        bindingGroup.addBinding(binding);
    ...
    private void btnPrimeiroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPrimeiroActionPerformed
        ...
        tblCliente.setRowSelectionInterval(0, 0); // vai pra primeira posição da tabela
        tblCliente.scrollRectToVisible(tblCliente.getCellRect(0, 0, true)); // vai pra primeira posição da tabela
        
    }//GEN-LAST:event_btnPrimeiroActionPerformed

    private void btnAnteriorActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnteriorActionPerformed
        // TODO add your handling code here:
        int linha = tblCliente.getSelectedRow(); // pega linha selecionada
        if(linha -1 >=0) { // verifica se nao e na primeira linha
            linha--; // decrementa
        }
        tblCliente.setRowSelectionInterval(linha, linha); // seleicona nossa linha
        tblCliente.scrollRectToVisible(tblCliente.getCellRect(linha, 0, true)); // mostra a linha selecionada
    ...
    private void btnNovoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNovoActionPerformed
        // TODO add your handling code here:
        listCliente.add((Cliente) new Cliente()); //criando uma lista na tabela novo objeto
        int linha = listCliente.size()-1; // pegando tamanho dele
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        int linhaSelecionada = tblCliente.getSelectedRow(); // pegar a linha que ta selecionada
        Cliente objCliente =listCliente.get(linhaSelecionada); //crio o objeto cliente e joga na linha
        daoCliente.salvar(objCliente); //pega o objeto no estado que ta e salva 
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        ...
        if (opcao == 0) { // se clicar em sim
            ...
            Cliente objCliente = listCliente.get(linhaSelecionada); // obtem o objeto que vai remover
            daoCliente.remover(objCliente); // atraves do dao vai remover
    ...
    private void btnProximoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProximoActionPerformed
        // TODO add your handling code here:
        int linha = tblCliente.getSelectedRow(); // pega intervalo da linha
        if(linha +1 <= tblCliente.getRowCount() -1) { // rowCount conta quantos registro tem na tabela, se tiver na ultima linha nao vai mais pra frente
            linha++; // decrementa
        }
        tblCliente.setRowSelectionInterval(linha, linha); // seleicona nossa linha
        tblCliente.scrollRectToVisible(tblCliente.getCellRect(linha, 0, true)); // mostra a linha selecionada
    ...
    private void btnUltimoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUltimoActionPerformed
        // TODO add your handling code here:
        int linha = tblCliente.getRowCount()-1; // contar a linha e por -1        
        tblCliente.setRowSelectionInterval(linha, linha); 
